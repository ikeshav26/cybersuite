                ...
                {!installationId ? (
                  <div className="space-y-3">
                    <div className="text-center py-4 bg-yellow-500/10 border border-yellow-500/30 rounded-lg">
                      <p className="text-yellow-400 text-sm mb-3">GitHub App not installed yet</p>
                      <a
                    ...
                    <div className="text-center">
                      ...
                      >
                        ...
                        Reconnect to Check Installation
                      </button>
                      <p className="text-gray-500 text-xs mt-2">
                        Click after installing the app to sync your installation
                      </p>
                    </div>
                  </div>
                ) : (
